...
BEGIN
    ALTER TABLE [AspNetUsers] ADD [FrequentFlyerNumber] nvarchar(max) NOT NULL DEFAULT N'';
END;
GO
...
BEGIN
    ALTER TABLE [AspNetUsers] ADD [HotelLoyaltyID] nvarchar(max) NOT NULL DEFAULT N'';
END;
GO
